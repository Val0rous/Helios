...
fun TimePicker(
    ...
    if (showTimePicker) {
        ...
        val expressiveToggleColors = TimePickerDefaults.colors(
        ...
        AlertDialog(
            ...
            text = {
                Column(
                    ...
                    if (showTimeInput) {
                        TimeInput(state = timePickerState, colors = expressiveToggleColors)
                    } else {
                        TimePicker(state = timePickerState, colors = expressiveToggleColors)
                    }
